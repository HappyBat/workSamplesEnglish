...
!(function (u) {
  ...
  function A(o) {
    ...
    function e(e) {
      var n;
      (n = e),
        o.id ? ((o.iframe.style[n] = o[n] + "px"), T(o.id, "IFrame (" + r + ") " + n + " set to " + o[n] + "px")) : T("undefined", "messageData id not set"),
        t(e);
    }
    var r = o.iframe.id;
    ...
    function r() {
      ...
      i && "contentWindow" in i && null !== i.contentWindow
        ? ((e = F[o] && F[o].targetOrigin),
          T(o, "[" + n + "] Sending msg to iframe[" + o + "] (" + t + ") targetOrigin: " + e),
  ...
  function d(i, e) {
    ...
    function o(e) {
      (e = e || {}),
        ...
        F[s] &&
          (F[s].targetOrigin =
            !0 === F[s].checkOrigin ? ("" === (e = F[s].remoteHost) || null !== e.match(/^(about:blank|javascript:|file:\/\/)/) ? "*" : e) : "*");
    }
    var r,
      a,
      s =
