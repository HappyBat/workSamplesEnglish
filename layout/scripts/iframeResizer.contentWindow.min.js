...
!(function (c) {
    ...
    (t = y.substr(M).split(":")),
      ...
      (D.parentIFrame = {
        autoResize: function (e) {
          return (
            !0 === e && !1 === i ? ((i = !0), he()) : !1 === e && !0 === i && ((i = !1), de("remove"), null !== s && s.disconnect(), clearInterval(T)),
  ...
  function de(e) {
    se({method: e, eventType: "Animation Start", eventNames: ["animationstart", "webkitAnimationStart"]}),
      ...
      se({method: e, eventType: "Transition End", eventNames: ["transitionend", "webkitTransitionEnd", "MSTransitionEnd", "oTransitionEnd", "otransitionend"]}),
      "child" === A && se({method: e, eventType: "IFrame Resized", eventName: "resize"});
  }
  function le(e, t, n, o) {
    return (
      t !== e && (e in n || (re(e + " is not a valid option for " + o + "CalculationMethod."), (e = t)), ie(o + ' calculation method set to "' + e + '"')), e
    );
  }
  function fe() {
    p = le(p, n, Z, "height");
